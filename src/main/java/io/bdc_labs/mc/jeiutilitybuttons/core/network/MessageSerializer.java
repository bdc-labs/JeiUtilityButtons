...
public final class MessageSerializer {
    ...
    static {
        ...
        MessageSerializer.mapHandler(int.class, FriendlyByteBuf::readInt, FriendlyByteBuf::writeInt);
        MessageSerializer.mapHandler(long.class, FriendlyByteBuf::readLong, FriendlyByteBuf::writeLong);
        MessageSerializer.mapHandler(float.class, FriendlyByteBuf::readFloat, FriendlyByteBuf::writeFloat);
        MessageSerializer.mapHandler(double.class, FriendlyByteBuf::readDouble, FriendlyByteBuf::writeDouble);
        MessageSerializer.mapHandler(boolean.class, FriendlyByteBuf::readBoolean, FriendlyByteBuf::writeBoolean);
        ...
        mapHandler(CompoundTag.class, FriendlyByteBuf::readAnySizeNbt, FriendlyByteBuf::writeNbt);
